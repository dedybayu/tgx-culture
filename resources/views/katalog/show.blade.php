    ...
    <div class="bg-white border border-slate-100 rounded-3xl p-6 sm:p-8 shadow-sm flex flex-col lg:flex-row gap-8">
        ...
        <div class="w-full lg:w-1/3 space-y-6">
            <div class="w-full aspect-[3/4] bg-slate-50 rounded-2xl overflow-hidden border border-slate-100 shadow-inner flex items-center justify-center relative group">
                <img src="{{ asset('storage/' . $katalog->path_gambar) }}" alt="{{ $katalog->judul }}" 
                    class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105"
                    onerror="this.src='https://images.unsplash.com/photo-1459749411175-04bf5292ceea?auto=format&fit=crop&w=600&q=80';">
            ...
            <div class="bg-slate-50 border border-slate-100 rounded-2xl p-4.5 space-y-3">
                <div class="flex justify-between items-center text-xs">
                    <span class="text-slate-400 font-medium">Petugas Pengelola</span>
        ...
        <div class="w-full lg:w-2/3 flex flex-col justify-between space-y-6">
            ...
            <div class="flex items-center gap-3 pt-4 border-t border-slate-100 justify-end">
                <button onclick="alert('Fitur Edit Katalog segera hadir!')" class="inline-flex items-center gap-2 px-5 py-2.5 bg-slate-900 hover:bg-slate-800 text-white text-xs font-bold rounded-xl shadow-sm transition-all">
